...
export const DEPARTMENT_WEIGHTS: DepartmentWeight[] = [
	{ department: 'Quantitative', weight: 0.30, can_veto: false },
	{ department: 'Technical', weight: 0.25, can_veto: false },
	{ department: 'Sentiment', weight: 0.20, can_veto: false },
	{ department: 'Fundamental', weight: 0.15, can_veto: false },
	{ department: 'Statistical', weight: 0.10, can_veto: false },
	{ department: 'Qualitative', weight: 0.00, can_veto: true }
];
