    ...
    <div class="space-y-4">
        ...
        <GlassCard className="p-4 sm:p-5">
          ...
          <div class="flex items-start justify-between mb-4">
            ...
            <div class="flex gap-2">
              <span class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-mono font-semibold {signal.direction === 'long' ? 'bg-emerald-500/15 text-emerald-400' : 'bg-rose-500/15 text-rose-400'}">
          ...
          <div class="grid grid-cols-3 gap-4 mb-4">
            <div>
              ...
              <p class="text-lg font-mono font-bold text-white/90">${signal.entry.toLocaleString('en-US', { minimumFractionDigits: signal.entry < 1000 ? 1 : 0, maximumFractionDigits: signal.entry < 1000 ? 1 : 0 })}</p>
            </div>
            <div>
          ...
          {#if signal.pnl}
            <div class="mt-4 pt-3 border-t border-white/[0.06]">
              <p class="text-sm font-mono {signal.pnl >= 0 ? 'text-emerald-400' : 'text-rose-400'}">
      ...
      {:else}
        <div class="text-center py-12">
          <p class="text-white/30 font-sans">No active signals</p>
        </div>
      {/each}
    </div>
